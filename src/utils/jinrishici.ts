...
function loadPhrase(callback: any, errHandler: any) {
...
function corsLoad(callback: (arg0: any) => void, errHandler: any) {
  const newCallBack = function (result: { token: string }) {
...
function sendRequest(
  callback: { (result: any): void; (arg0: any): void },
  errHandler: (arg0: any) => void,
  apiUrl: string | URL
) {
